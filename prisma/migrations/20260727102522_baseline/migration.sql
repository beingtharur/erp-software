...
CREATE TABLE "SiteVisit" (
    ...
    CONSTRAINT "SiteVisit_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "Site" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "AmcContract" (
    ...
    CONSTRAINT "AmcContract_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "Site" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
